...
A coleta sistemática de dados de consumo elétrico ocorre via sensores em tempo real, tomadas/disjuntores inteligentes e medição global. O grande volume de dados exige infraestrutura de armazenamento robusta (NAS, nuvem, servidores locais), com segurança (criptografia, autenticação), compressão e normalização para otimizar o armazenamento e processamento.
...
\begin{itemize}
    ...
    \item \textbf{Detecção de Anomalias Avançada}: Aprendizado de máquina para identificar anomalias sutis.
