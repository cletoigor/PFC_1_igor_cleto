...
Este projeto tem como objetivo desenvolver um sistema inteligente para monitoramento de energia
utilizando controle estatístico de processo (CEP) em residências que não foram projetadas originalmente para automação residencial.
...
uso, implementar algoritmos de processamento de dados e controle estatístico de processos (CEP) para o monitoramento de energia, criar uma plataforma de software intuitiva para visualização e análise dos dados pelos
