...
\vspace{6cm}
{\bf\Large Monitoramento e controle de processos para o consumo de energia residencial baseado em Sistemas
...
\vspace{2cm}
\centering
\textbf{Monitoramento e controle de processos para o consumo de energia residencial baseado em Sistemas
Inteligentes}\\
\vspace{5cm} 
