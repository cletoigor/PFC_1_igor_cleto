...
Em suma, este trabalho logrou êxito em desenvolver e validar um sistema integrado para monitoramento e controle de energia residencial, atendendo à maioria dos objetivos propostos e superando os desafios inerentes à integração de diferentes tecnologias e à aplicação de conceitos analíticos em um contexto prático. A solução apresentada não apenas cumpre os requisitos de um Trabalho de Conclusão de Curso em Engenharia de Controle e Automação, mas também oferece uma contribuição tangível ao campo da gestão energética inteligente, fornecendo uma plataforma funcional e insights valiosos. O projeto estabelece uma base sólida para futuras pesquisas e desenvolvimentos, com potencial para evoluir para uma ferramenta ainda mais poderosa e impactante na promoção da eficiência energética e da sustentabilidade em ambientes domésticos.
