...
\newcommand{\htmladdnormallink}[2]{\href{#1}{#2}} % Fix for abntex2cite url issue
...
\raggedbottom % Allow flexible bottom margin to help with underfull vbox issues
...
%\bibliographystyle{abntex2-num} % Use abntex2-num style for numeric citations
